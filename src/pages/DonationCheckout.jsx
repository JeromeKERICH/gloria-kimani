...
export default function DonationCheckout() {
  ...
  const handleSubmit = (e) => {
    ...
    const handler = window.PaystackPop.setup({
      key: 'import.process.meta.VITE_PAYSTACK_KEY', 
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">SH</span>
                  <input
                    type="number"
                    id="amount"
                    name="amount"
                    ...
                    onChange={handleChange}
                    className="w-full pl-8 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF6B6B] focus:border-transparent font-opensans"
                    placeholder="1000"
                  />
                </div>
              </div>
